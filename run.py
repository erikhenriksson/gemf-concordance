...
for i in [0, 1]:
    if i == 0:
        filename = "index.html"
        links = '<h2 id="sort"><a href="/gemf" class="active">Sort alphabetically</a> <a href="/gemf/sorted.html">Sort by frequency</a> <a href="/gemf/graph.jpg">Word co-occurrence network</a></h2>'
        myKeys = list(cc.keys())
        myKeys.sort(
        ...
        links = '<h2 id="sort"><a href="/gemf">Sort alphabetically</a> <a  class="active" href="/gemf/sorted.html">Sort by frequency</a> <a href="/gemf/graph.jpg">Word co-occurrence network</a></h2>'
